...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        xTile = math.floor(pos.getX())
        yTile = math.floor(pos.getY())
        tile = (xTile, yTile)
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        newPos = self.position.getNewPosition(self.getRobotDirection(), self.speed)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for i in range(num_trials):
        ...
        roomSize = float(room.getNumTiles())
        roomCoverage = room.getNumCleanedTiles()/roomSize
        ...
        while roomCoverage < min_coverage:
            ...
            for robot in robots:
                ...
                roomCoverage = room.getNumCleanedTiles()/roomSize
            timeClicks += 1
        trialResults.append(timeClicks)
        #anim.done()
...
#avg = runSimulation(10, 1.0, 15, 20, 0.8, 30, RandomWalkRobot)
#print avg
